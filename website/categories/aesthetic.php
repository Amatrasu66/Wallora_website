...
<body>
  ...
  <h1>Aesthetic Wallpapers</h1>

  <div class="gallery-container">
    <?php
      $res = mysqli_query($conn,
        "SELECT filename, title FROM wallpapers WHERE category='aesthetic' ORDER BY uploaded_at DESC"
      );
    ...
    ?>
      <p style="text-align:center;">No aesthetic wallpapers found.</p>
    <?php endif; ?>
  </div>
