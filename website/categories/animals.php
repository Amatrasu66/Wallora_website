...
<head>
  <meta charset="UTF-8">
  <title>Wallora Animals Category</title>
...
<body>
  ...
  <h1>Animals Wallpapers</h1>

  <div class="gallery-container">
    <?php
      $res = mysqli_query($conn,
        "SELECT filename, title FROM wallpapers WHERE category='animals' ORDER BY uploaded_at DESC"
      );
    ...
    ?>
      <p style="text-align:center;">No animals wallpapers found.</p>
    <?php endif; ?>
  </div>
