...
<head>
  <meta charset="UTF-8">
  <title>Wallora Anime Category</title>
  ...
  <div class="gallery-container">
    <?php
      $res = mysqli_query($conn,
        "SELECT filename, title FROM wallpapers WHERE category='anime' ORDER BY uploaded_at DESC"
      );
    ...
    ?>
      <p style="text-align:center;">No anime wallpapers found.</p>
    <?php endif; ?>
  </div>
