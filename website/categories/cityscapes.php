...
<head>
  <meta charset="UTF-8">
  <title>Wallora Cityscapes Category</title>
...
<body>
  ...
  <h1>Cityscapes Wallpapers</h1>

  <div class="gallery-container">
    <?php
      $res = mysqli_query($conn,
        "SELECT filename, title FROM wallpapers WHERE category='cityscapes' ORDER BY uploaded_at DESC"
      );
    ...
    ?>
      <p style="text-align:center;">No cityscapes wallpapers found.</p>
    <?php endif; ?>
  </div>
