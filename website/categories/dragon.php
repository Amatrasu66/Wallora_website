...
<head>
  <meta charset="UTF-8">
  <title>Wallora Dragon Category</title>
...
<body>
  ...
  <h1>Dragon Wallpapers</h1>

  <div class="gallery-container">
    <?php
      $res = mysqli_query($conn,
        "SELECT filename, title FROM wallpapers WHERE category='dragon' ORDER BY uploaded_at DESC"
      );
    ...
    ?>
      <p style="text-align:center;">No dragon wallpapers found.</p>
    <?php endif; ?>
  </div>
