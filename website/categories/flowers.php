...
<head>
  <meta charset="UTF-8">
  <title>Wallora Flowers Category</title>
...
<body>
  ...
  <h1>Flowers Wallpapers</h1>

  <div class="gallery-container">
    <?php
      $res = mysqli_query($conn,
        "SELECT filename, title FROM wallpapers WHERE category='flowers' ORDER BY uploaded_at DESC"
      );
    ...
    ?>
      <p style="text-align:center;">No flowers wallpapers found.</p>
    <?php endif; ?>
  </div>
