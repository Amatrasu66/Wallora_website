...
<head>
  <meta charset="UTF-8">
  <title>Wallora Nature Category</title>
  ...
  <div class="gallery-container">
    <?php
      $res = mysqli_query($conn,
        "SELECT filename, title FROM wallpapers WHERE category='nature' ORDER BY uploaded_at DESC"
      );
    ...
    ?>
      <p style="text-align:center;">No Nature wallpapers found.</p>
    <?php endif; ?>
  </div>
