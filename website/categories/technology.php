...
<head>
  <meta charset="UTF-8">
  <title>Wallora Technology Category</title>
...
<body>
  ...
  <h1>Technology Wallpapers</h1>

  <div class="gallery-container">
    <?php
      $res = mysqli_query($conn,
        "SELECT filename, title FROM wallpapers WHERE category='technology' ORDER BY uploaded_at DESC"
      );
    ...
    ?>
      <p style="text-align:center;">No Technology wallpapers found.</p>
    <?php endif; ?>
  </div>
